                        ...
                        <form>
                            ...
                            <div className={classes.row}>
                                <div className={classes.col25} >
                                    ...
                                    <input type="text" className={classes.div} id="email" name="email" placeholder="tanzeel@example.com" required />
                                    ...
                                    <input type="text" className={classes.div} id="city" name="city" placeholder="Australia" required />
                                ...
                                <div className={classes.col50}>
                                    ...
                                    <input type="text" className={classes.div} id="cname" name="cardname" placeholder="Tanzeel Rahim" required />
                                    ...
                                    <div className={classes.row}>
                                        <div className={classes.col50}>
                                            ...
                                            <input type="date" className={classes.div} id="expyear" name="expyear" placeholder="9-10-2018" required />
                                        </div>
                                        <div className={classes.col50}>
